...
from vlm_grpo.rewards.verifier import verify_answer  # noqa: E402
...
TESTS = [
    ...
    (
        "MCQ",
        "mcq",
        "I believe the answer is D based on the image",
        "D",
        True,
    ...
    ("MCQ", "mcq", "(d) This image contains a bowl.", "D", True, "Lowercase letter with text"),
    # =========================================================================
    ...
    ("MCQ-text", "mcq", "taxi", "Cab", True, "Text GT synonym (needs LLM judge)"),
    ("MCQ-text", "mcq", "bus", "Cab", False, "Text GT completely wrong"),
    ("MCQ-text", "mcq", "office", "office", True, "Text GT office exact"),
    ("MCQ-text", "mcq", "an office setting", "office", True, "Text GT with elaboration"),
    ...
    ("YesNo", "yesno", "I think so, probably yes.", "Yes", False, "Hedging with yes"),
    ...
    (
        ...
        "Yes, there is a television set visible in the living room.",
        True,
        "Paraphrased TV → television (same meaning)",
    ),
    (
        "YN-sent",
        "yesno",
        ...
        False,
        "Same polarity but WRONG objects (bottles vs breads)",
    ),
    (
        "YN-sent",
        "yesno",
        ...
        False,
        "Same polarity but UNRELATED topics",
    ),
    (
        "YN-sent",
        "yesno",
    ...
    (
        ...
        False,
        "Opposite polarity with explanation",
    ),
    # =========================================================================
    ...
    ("Count", "counting", "1", "0", True, "Off by 1 from GT=0 (fixed: score~0.67)"),
    ("Count", "counting", "2", "1", True, "Off by 1 from GT=1 (fixed: score~0.67)"),
    ("Count", "counting", "0", "1", True, "Off by 1 from GT=1 other dir (score~0.67)"),
    (
        "Count",
        "counting",
        "There are three cats in the image",
        "3",
        True,
    ...
    ("Short", "open", "the color is red", "red", True, "Verbose contains GT (substring)"),
    ("Short", "open", "blue", "red", False, "Wrong color"),
    ("Short", "open", "December", "December", True, "Month exact"),
    ("Short", "open", "fire truck", "fire truk", True, "Typo handled by ANLS"),
    (
        "Short",
        "open",
        "kitchen table",
    ...
    ("Short", "open", "NYC", "New York City", None, "Abbreviation (may need LLM judge)"),
    # =========================================================================
    ...
    (
        ...
        True,
        "Paraphrased cooking description",
    ),
    (
        "Open",
        "open",
        ...
        True,
        "Same observation different wording",
    ),
    (
        "Open",
        "open",
    ...
    (
        ...
        False,
        "Antonym contradiction (left vs right)",
    ),
    (
        "Open",
        "open",
    ...
    (
        ...
        True,
        "Different structure same content (needs LLM judge)",
    ),
    (
        "Open",
        "open",
        ...
        None,
        "Similar scene slightly different (borderline)",
    ),
    (
        "Open",
        "open",
        ...
        True,
        "Same safety advice, GT is more detailed",
    ),
    (
        "Open",
        "open",
    ...
    (
        ...
        True,
        "Thought/Answer yesno with paraphrase",
    ),
    # =========================================================================
    # Edge cases
    # =========================================================================
    ...
    (
        ...
        False,
        "Refusal vs actual answer",
    ),
    ("Edge", "open", "N/A", "The building is a church.", False, "N/A response"),
...
def main() -> None:
    ...
    for cat, counts in sorted(results_by_category.items()):
        ...
        print(
            f"  {cat:<12}: {counts['pass']}/{cat_total} pass"
    ...
    reward_tests = [
        ...
        (
            "open",
            "The man is making pizza.",
            "The man is spreading marinara sauce on pizza dough.",
            "Paraphrase",
        ),
